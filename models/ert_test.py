...
min_sample_leaf = round(y.shape[0] * 0.001)
min_sample_split = min_sample_leaf * 10
model = ExtraTreesRegressor(n_estimators=500, min_samples_leaf=min_sample_leaf,
                            min_samples_split=min_sample_split, random_state=42, max_depth=None, n_jobs=-1,
                            max_features=5, criterion='mse')
